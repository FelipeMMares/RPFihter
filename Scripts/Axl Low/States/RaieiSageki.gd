...
@export var animation_name: StringName = &"RaieiSageki"
...
@export_range(0, 60, 1)
var movement_start_frame: int = 2

@export_range(0, 60, 1)
var movement_end_frame: int = 7
...
@export var effect_animation_name: StringName = &"RaieiSageki"

@export_range(0, 60, 1)
var effect_start_frame: int = 3

@export_range(0, 60, 1)
var effect_end_frame: int = 8
...
func _physics_process(
	...
	if (
		current_frame >= movement_start_frame
		and current_frame <= movement_end_frame
	):
